...
import { CreateGroupModal } from "@/components/client";
import { useServerAction } from "@/hooks";

const ContactsPage = () => {
  const router = useRouter();

  const { data, isLoading } = useServerAction(getAllContacts);
  ...
  useEffect(() => {
    if (!shouldOpenCreateGroup) return;

    router.replace("/contacts", { scroll: false });
  }, [shouldOpenCreateGroup, router]);
